        ...
        <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mt-12'>
            {
                categoryItems.map((item, i) => (
                    <div key={i} className='shadow-lg rounded-md bg-white py-6 px-3 w-full max-w-[280px] mx-auto text-center cursor-pointer hover:-translate-y-4 transition-all duration-300 z-10'>
